const ContactUs = () => {
  return (
    <>
      <div className='relative flex items-center justify-center h-[200px] sm:h-[300px] w-full mb-5'>
        ...
        <h1 className='absolute text-center z-20 font-bold text-5xl sm:text-8xl text-white'>CONTACT US</h1>
      </div>
     <div className='w-full flex flex-col gap-5 py-10'>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-evenly gap-10 sm:gap-5'>
            <div className='w-[80%] sm:w-[30%] h-[200px] flex flex-col items-center justify-center gap-2 shadow-[0_0_10px_rgba(0,0,0,0.3)] p-6 bg-white rounded-lg'>
