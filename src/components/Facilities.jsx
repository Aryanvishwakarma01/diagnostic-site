...
const Facilities = () => {
  ...
  return (
    <div className="facilities w-full bg-gray-200 px-[30px] py-[25px] sm:p-15 flex flex-col gap-8 sm:gap-15">
      <h1 className="text-[30px] sm:text-4xl text-center font-bold">OUR <span className="text-orange-500">FACILITIES</span></h1>
      ...
      <div className='flex items-center justify-center gap-5'>
        <button onClick={reloadPage} className='border px-6 py-3 rounded-4xl bg-red-500 hover:bg-red-700 border-none transition duration-300 text-white text-[14px] sm:text-[18px] font-bold cursor-pointer'><NavLink to="/contact-us">Book Appointment</NavLink></button>
        <button className='border px-6 py-3 rounded-4xl bg-green-700 hover:bg-orange-500 transition duration-300  text-white text-[14px] sm:text-[18px]  font-bold cursor-pointer'><a href="tel:9646548046"><i className="ri-phone-fill"></i> Call Now</a>
        </button>
      </div>
    </div>
  );
