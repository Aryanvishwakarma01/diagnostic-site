  ...
  return (
    ...
    <div className="footer w-full bg-gray-800 flex items-start justify-between px-2 sm:px-20 py-8">
        ...
        <div className="flex gap-3 text-2xl">
         ...
         <div className="flex flex-col w-[30%] sm:w-[25%] text-white gap-5"><h1 className="border-b-2 text-center text-xl sm:text-2xl py-2 font-bold">Useful Links</h1>
        <ul className="text-sm items-center justify-center flex flex-col gap-2">
            <li className="hover:border-b-2 w-max px-auto  border-white"><Link to="/">HOME</Link></li>
            <li className="hover:border-b-2 w-max px-auto  border-white"><Link to="../About">ABOUT US</Link></li>
            <li className="hover:border-b-2 w-max px-auto  border-white"><Link to="../Facility">FACILITIES</Link></li>
            <li className="hover:border-b-2 w-max px-auto  border-white"><Link to="../ContactUs">CONTACT US</Link></li>
        </ul>
        </div>

        <div className="flex flex-col w-[30%] sm:w-[25%] text-white gap-5"><h1 className="border-b-2 text-center text-xl sm:text-2xl py-2 font-bold">Contact</h1>
