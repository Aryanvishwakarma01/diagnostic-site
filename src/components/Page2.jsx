...
const Page2 = () => {
  return (
    ...
    <div className="page2_left relative w-[100%] sm:w-[50%] p-[10px] sm:p-0 flex flex-col gap-6">
      <h1 className='text-4xl sm:text-[35px] font-bold text-center w-full  sm:text-center'>Welcome to <span className='text-orange-500'>Harsha Lab & Diagnostic</span></h1>
