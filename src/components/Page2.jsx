  ...
  return (
    ...
    <div className="page2_left relative w-[100%] sm:w-[50%] p-[10px] sm:p-0 flex flex-col gap-6">
      ...
      <div className="page2_buttons flex items-center justify-center sm:justify-start gap-3">
        <button className='border py-3 sm:py-4 px-6 sm:px-10 text-sm sm:text-[18px] rounded-4xl text-white bg-green-700 hover:bg-orange-500 transition duration-300 font-bold cursor-pointer'>Read More</button>
        <button className='border py-3 sm:py-4 px-6 sm:px-10 rounded-4xl text-sm sm:text-[18px] text-white bg-green-700 hover:bg-orange-500 transition duration-300 font-bold'><i className="ri-phone-fill"></i><a href="tel:9646548046"> Call Now</a></button>
      </div>
    </div>
