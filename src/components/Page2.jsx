  ...
  return (
    ...
    <div className="page2_left relative w-[50%] flex flex-col gap-6">
      ...
      <div className="page2_buttons flex items-center gap-3">
        ...
        <button className='border py-4 px-10 rounded-4xl text-white bg-green-700 font-bold'><i className="ri-phone-fill"></i><a href="tel:9646548046"> Call Now</a></button>
      </div>
    </div>
    <div className="page2_right w-2/5 sm:w-1/6  object-cover">
